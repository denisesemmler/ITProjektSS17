						...
						public void onSuccess(Teilnehmer result) {
							...
							if (result.isLoggedIn()) {
								if (result.isExisting() == false) {
									...
									//Profil Id suchen des Nutzers um dann zu prüfen ob Eigenschaften schon vorhanden
...
private class GetEigenschaftCallback implements AsyncCallback<Vector<Eigenschaft>> {
	...
	public void onSuccess(Vector<Eigenschaft> result) {
		...
		//wenn user existing aber zurückgegebener Vektor von Eigenschaften leer ist, dann auf die ProfilAnlegen seite leiten
