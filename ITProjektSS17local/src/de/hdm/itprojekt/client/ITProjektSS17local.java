...
public class ITProjektSS17local implements EntryPoint {
	 ...
	 */
	private final  ProjektAdministrationAsync projektAdministration = GWT.create(ProjektAdministration.class);
	...
	public void onModuleLoad() {
		...
		final String zusatz = "Mustermann";
		final String emailAdresse = "test@test.de";
		final int rolle = 1;
		...
		class MyHandler implements ClickHandler {
			...
			public void onClick(ClickEvent event) {
				...
				projektAdministration.createTeilnehmer(name, zusatz, emailAdresse, rolle, new AsyncCallback<Teilnehmer>() {
