...
public class AusschreibungBearbeiten extends VerticalPanel {
		...
		private class OnChangeHandler implements ChangeHandler {
			...
			public void onChange(ChangeEvent event) {
				try { //Bei Änderung der Auswahl in der Listbox, die Daten der geäwhlten Ausschreibung anzeigen
					ausschreibungTitelBox.setText(aVector.elementAt(ausschreibungListbox.getSelectedIndex()).getTitel());
					stellenbeschreibungArea.setText(aVector.elementAt(ausschreibungListbox.getSelectedIndex()).getBeschreibung());
					...
					ClientSideSettings.getProjektAdministration().findNameAndWertFromEigenschaften(aVector.elementAt(ausschreibungListbox.getSelectedIndex()).getProfil_idSuchprofil(),
		...
		private class GetEigenschaftCallback implements AsyncCallback<Vector<Eigenschaft>> {
			...
			public void onSuccess(Vector<Eigenschaft> result) {
				//Zuerst Panel clearen, damit immer nur eigenschaften der aktuellen Ausschreibung gezeigt werden
		...
		private class SpeichernClickHandler implements ClickHandler {
			...
			public void onClick(ClickEvent event) {
				//Bei Speicherung neue Daten im Objekt speichern und updaten sowie Profil updaten
				try {
		...
		private class SpeichernCallback implements AsyncCallback<Void> {
			...
			//Wenn Daten der AUsschreibung geändert, dann Eigenschaften im Suchprofil aktualisieren
		...
		private class UpdateEigenschaftenCallback implements AsyncCallback<Void> {
			...
			public void onSuccess(Void result) {
				//Wenn Eigenschaften auch aktualisiert, RootPanel clearen und auf Übersichtsseite zurück
