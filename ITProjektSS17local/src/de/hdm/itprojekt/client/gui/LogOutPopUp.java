...
/**
 * Diese Gui-Klasse erbt vom PopupPanel. Sie ist fuer die Darstellung der
 * Logoutabfrage zustaendig
 * 
 * @author Philipp
 * 
 **
...
public class LogOutPopUp extends PopupPanel {
	...
	/**
	 * Im No-Argument-Konstruktor wird das Panel sichtbar gemacht, Styles werden
	 * den sichtbaren Elementen zugewiesen und die Elemente werden dem Panel
	 * hinzugefuegt
	 */
	public LogOutPopUp() {
		super(true);
	...
	/**
	 * ClickHandler zum schliessen des Popups, der den das Objekt, welches in
	 * der ItProjektSS17-Klasse erstellt wurde holt und die sichtbarkeit
