...
/**
 * Klasse die die Ausschreibungen anzeigt, die mit dem Profil des Benutzer übereinstimmen
	...
	private class AusschreibungAnzeigenClickHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			...
			try {
				...
				a.setProfil_idSuchprofil(aVector.elementAt(passendeAusschreibungListBox.getSelectedIndex()).getProfil_idSuchprofil());
